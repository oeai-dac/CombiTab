/*
 * Service Worker (§13) — macht CombiTab offline-/installierbar.
 *
 ...
 * einem Unterpfad (GitHub Pages liefert unter /CombiTab/ aus). Absolute Pfade
 * würden dort auf die Domainwurzel zeigen und der Install scheiterte.
 */
const CACHE = "combitab-v2.0.0";
